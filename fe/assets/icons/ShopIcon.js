  ...
  return (
    ...
    >
      <Path
        stroke={color}
        strokeWidth={1.5}
        d="M3.5 11v3c0 3.771 0 5.657 1.172 6.828C5.844 21.999 7.729 22 11.5 22h1c3.771 0 5.657 0 6.828-1.172C20.499 19.656 20.5 17.771 20.5 14v-3"
      />
      <Path
        stroke={color}
        strokeWidth={1.5}
